...
export const PostsData = {
    ...
    add: function (TitleInput, ContentInput, ImageInput) {
        PostsData.posts.unshift({ title: TitleInput, date: "Dzisiaj", content: ContentInput, categories: ["Testowe"], image: ImageInput, ID: Math.floor(Math.random() * 10000) })
    }
};
